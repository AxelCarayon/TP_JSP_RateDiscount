<%-- 
    Document   : TauxRemise
    Created on : 5 nov. 2019, 12:58:08
    Author     : Axel
--%>
			...
			<div class="tbody">		    
                            <c:forEach var="discount" items="${discounts}">
                                <form class="tr" method="get">
                                    <div class="td"><input type="text" name="code" value="${discount.code}" readonly/></div>
                                    <div class="td"><input name="taux" type="text" size="5" value="${discount.rate}"/></div>
